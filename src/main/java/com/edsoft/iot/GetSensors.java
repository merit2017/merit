...
public class GetSensors {
    private static String url = "coap://[aaaa::c30c:0:0:2]:5683/test/sensors";
            ...
            while (true) {//For observer, I use while(true)
                ...
                if (null != response) {
                    ...
                    if (responseString.startsWith("NON")) {
                        ...
                        Data cpuvalue = new Data(values2[0], values2[1], values2[2]);              //Alınan veriler Data nesnesi olarak tutuluyor.
                        Data memvalue = new Data(values2[3], values2[4], values2[5]);             //Alınan veriler Data nesnesi olarak tutuluyor.
                                ...
                                DataProducer.sendKafkaFromSensors(cpuvalue,memvalue);
                            } else {
